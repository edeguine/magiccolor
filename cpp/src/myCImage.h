...
class myCImage : public myImage {
  ...
  myCImage(int _w, int _h) {
	...
	static void loadImage(std::string filename, myImage* dest);
	myColorRGB getCol(myPoint point, bool wrap = false); 
	void setCol(myPoint point, myColorRGB col, bool wrap = false);
